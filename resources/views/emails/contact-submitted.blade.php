...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
    ...
    <div style="background: #f5f5f5; padding: 15px; border-radius: 5px;">{{ $contact->message }}</div>
    <p style="margin-top: 20px; color: #666; font-size: 12px;">Sent from Easy IT Website Contact Form</p>
</body>
</html>
