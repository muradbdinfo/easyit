    ...
    <AdminLayout>
        ...
        <form @submit.prevent="submit" class="space-y-6 max-w-3xl">
            <div class="bg-white shadow rounded-lg p-6 space-y-4">
                ...
                <FormInput v-model="form.icon" label="Icon Name" :error="form.errors.icon" placeholder="e.g. network, globe, server" />
                <ImageUpload label="Service Image" :error="form.errors.image" @file-selected="file => form.image = file" />
